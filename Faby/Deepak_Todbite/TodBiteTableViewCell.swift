...
class TodBiteTableViewCell: UITableViewCell {
    ...
    private func setupViews() {
        ...
        NSLayoutConstraint.activate([
            ...
            nameLabel.topAnchor.constraint(equalTo: contentView.topAnchor, constant: 12), // Increased padding
            ...
            descriptionLabel.topAnchor.constraint(equalTo: nameLabel.bottomAnchor, constant: 6), // Increased spacing
            descriptionLabel.leadingAnchor.constraint(equalTo: nameLabel.leadingAnchor),
            descriptionLabel.trailingAnchor.constraint(equalTo: nameLabel.trailingAnchor),
            descriptionLabel.bottomAnchor.constraint(equalTo: contentView.bottomAnchor, constant: -12), // Increased padding
