...
class TopicsDataManager {
    ...
    let cardData: [Topics] = [
        ...
        Topics(title: "Managing Tantrums", subtitle: "Emotional Understanding, Calming Techniques, Boundaries, etc.",imageView: "Managing Tantrums"),
        ...
        Topics(title: "Special Needs Support", subtitle: "Special Needs Programs, Individualized Support, etc.",imageView: "Nutrution")
    ]
}
